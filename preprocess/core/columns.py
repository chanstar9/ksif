...
# summary of match the freq (default is last) -> specify flow and stock
FIRST_LIST = [OPEN_P]
MAX_LIST = [HIGH_P]
MIN_LIST = [LOW_P]
SUM_LIST = [TRADING_VOLUME, TRADING_VOLUME_P, SHORT_SALE_VOLUME, SHORT_SALE_BALANCE, NET_PERSONAL_PURCHASE,
            NET_NATIONAL_PURCHASE, NET_FINANCIAL_INVESTMENT_PURCHASE,
            NET_INSTITUTIONAL_FOREIGN_PURCHASE, NET_INSTITUTIONAL_PURCHASE, NET_ETC_FINANCE_PURCHASE,
            NET_ETC_CORPORATION_PURCHASE, NET_ETC_FOREIGN_PURCHASE, NET_REGISTERED_FOREIGN_PURCHASE,
            NET_INSURANCE_PURCHASE, NET_PRIVATE_FUND_PURCHASE, NET_PENSION_PURCHASE, NET_FOREIGN_PURCHASE,
            NET_BANK_PURCHASE, NET_TRUST_PURCHASE, SHARE_LENDING_VOLUME]
PROD_LIST = [ADJ_C, DIV_ADJ_C]
